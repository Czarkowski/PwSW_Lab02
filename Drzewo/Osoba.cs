...
namespace Osoba
{
    public struct Data
    {
        ...
        public Data(int rok, byte miesiac, byte dzien)
        {
            ...
            if (rok < 1900 || miesiac > 12 || miesiac < 1 || flaga)
    ...
    public class  Osoba
    {
        ...
        public Osoba() : this("Jan","Kowalski",1990,12,1)
        {
        ...
        public Osoba(Osoba osoba)
        {
            ...
            this.dataUrodzenia = new(osoba.dataUrodzenia);
        }
        public Osoba(string imie, string nazwisko, int rok, byte miesiec, byte dzien)
        {
            this.imie = imie;
            this.nazwisko = nazwisko;
            this.dataUrodzenia = new(rok,miesiec,dzien);
        }
